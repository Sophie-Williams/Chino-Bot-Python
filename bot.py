...
async def on_message(message):
	...
	elif message.content.startswith("ghi"):
		await client.send_message(message.channel, "jkl")
	elif message.content.startswith("mno"):
		await client.send_message(message.channel, "pqr")
